...
| **1** | Aves | Datos en repo, listado+buscador, detalle, PDF, deploy `aves.chirimoyo.org` | Trabajo más avanzado y mayor diferenciador del humedal |
| **2** | Anfibios | Anfibios/reptiles como categoría, filtros por grupo | Reusa toda la Fase 1; alcance pequeño (~10 especies) |
