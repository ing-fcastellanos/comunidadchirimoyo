...
- [x] 6.1 (POST-DEPLOY, requiere tokens reales) En cada dominio, comprobar que el pageview llega al "site" correcto en el panel de Cloudflare
- [x] 6.2 (POST-DEPLOY) Verificar en DevTools (Application/Network) que no se establecen cookies de rastreo ni se envía PII, y que no aparece banner
...
- [ ] 7.1 Actualizar/cerrar la parte correspondiente de la épica #24 con lo implementado (comentario redactado; pendiente de postear — requiere tu visto bueno)
