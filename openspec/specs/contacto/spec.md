...
Recepción, validación, persistencia y notificación por correo de mensajes de contacto del público que envía el formulario del landing (`chirimoyo.org`). Firestore es la fuente de verdad y el correo es best-effort. Incluye consentimiento de privacidad (ADR-0012), anti-spam por honeypot y logging sin PII.
