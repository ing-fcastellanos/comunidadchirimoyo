# aviso-privacidad Specification

## Purpose

Publicación del aviso de privacidad del proyecto Comunidad Chirimoyo como página estática `/privacidad` en `apps/sitio`. El contenido vive versionado en `content/landing/privacidad.md` y se renderiza con el patrón de secciones existente. La página es la única fuente de verdad del aviso, enlazada desde los formularios que recaban PII (contacto y, a futuro, inscripción de voluntarios), y cubre el contenido legal mínimo de la LFPDPPP de forma coherente con el ADR-0012.
