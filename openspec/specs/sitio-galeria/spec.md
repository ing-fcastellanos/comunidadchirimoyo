# sitio-galeria Specification

## Purpose
Definir la galería de fotos de comunidad de la app de sitio: el almacenamiento de las imágenes del humedal, jornadas y eventos en un bucket de Google Cloud Storage propio (separado del bucket de fauna), y la página `/galeria` con una rejilla tolerante a orientaciones mixtas y un lightbox accesible, con la lista de fotos resuelta en build.
